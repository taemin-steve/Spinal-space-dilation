...
IMG_PATH ='./circle_images/1_Color.png'
...
# circle 좌표를 찾음
ret, corners = cv.findCirclesGrid(imgInit,(6,3),flags=cv.CALIB_CB_SYMMETRIC_GRID+cv.CALIB_CB_CLUSTERING,blobDetector=detector)
points2Ds.append(corners)
# flip
points2Ds[0]=np.flip(points2Ds[0],0)
