...
IMG_PATH ='./c-arm 2023-05-09/'+ str(7806)+ '.png'
...
cv.circle(remake_image, (569, 711), 43, (0, 0, 0), 3)
cv.imwrite("./c-arm 2023-05-09/remake7806.png", remake_image)

remake_image = cv.resize(remake_image, (700,700))
cv.imshow('reImage',remake_image) 

remake_image = cv.imread('./c-arm 2023-05-09/remake7806.png')
